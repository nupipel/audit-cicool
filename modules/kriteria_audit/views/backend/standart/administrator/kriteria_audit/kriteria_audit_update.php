...
<section class="content-header">
    <h1>
        Kriteria Audit        <small>Edit Kriteria Audit</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Kriteria Audit</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/kriteria_audit/edit_save/'.$this->uri->segment(4)), [
                        ...
                        <div class="form-group group-no_kriteria  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="no_kriteria" id="no_kriteria" placeholder="" value="<?= set_value('no_kriteria', $kriteria_audit->no_kriteria); ?>">
                        ...
                        <div class="form-group group-kriteria  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="kriteria" id="kriteria" placeholder="" value="<?= set_value('kriteria', $kriteria_audit->kriteria); ?>">
                                    <small class="info help-block">
...
<script>
    ...
    $.ajax({
            url: form_kriteria_audit.attr('action'),
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
        .done(function(res) {
            ...
            if (res.success) {
                var id = $('#kriteria_audit_image_galery').find('li').attr('qq-file-id');
                if (save_type == 'back') {
