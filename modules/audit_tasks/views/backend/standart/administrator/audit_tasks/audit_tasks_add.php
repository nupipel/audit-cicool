                        ...
                        ?>
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="col-md-3  padding-left-0">
                                        <label>
                                            <input type="checkbox" class="flat-red" name="lingkup_audit[]" value="<?= $row->no_kriteria ?>"> <?= $row->kriteria; ?>
                                        </label>
                                    </div>
                                    <?php endforeach; ?>
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="jadwal" id="jadwal" placeholder="Jadwal" value="<?= set_value('jadwal'); ?>">
                                    <small class="info help-block">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="kriteria_audit" id="kriteria_audit" placeholder="Kriteria Audit" value="<?= set_value('kriteria_audit'); ?>">
                                    <small class="info help-block">
                                ...
                                <div class="col-sm-8">
                                    <textarea id="ket_kriteria_tdk_berlaku" name="ket_kriteria_tdk_berlaku" rows="5" cols="80"><?= set_value('Ket Kriteria Tdk Berlaku'); ?></textarea>
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="uraian_tdk_sesuai" id="uraian_tdk_sesuai" placeholder="Uraian Tdk Sesuai" value="<?= set_value('uraian_tdk_sesuai'); ?>">
                                    <small class="info help-block">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="uraian_temuan" id="uraian_temuan" placeholder="Uraian Temuan" value="<?= set_value('uraian_temuan'); ?>">
                                    <small class="info help-block">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="lead" id="lead" placeholder="Lead" value="<?= set_value('lead'); ?>">
                                    <small class="info help-block">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="member1" id="member1" placeholder="Member1" value="<?= set_value('member1'); ?>">
                                    <small class="info help-block">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="member2" id="member2" placeholder="Member2" value="<?= set_value('member2'); ?>">
                                    <small class="info help-block">
