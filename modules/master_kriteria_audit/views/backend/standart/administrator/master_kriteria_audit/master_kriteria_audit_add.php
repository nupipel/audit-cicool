...
<section class="content-header">
    <h1>
        Master Kriteria Audit <small><?= cclang('new', ['Master Kriteria Audit']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Master Kriteria Audit']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select-deselect" name="id_subklausul" id="id_subklausul" data-placeholder="Select Parent Subklausul Audit">
                                    ...
                                    <?php foreach (db_get_all_data('master_subklausul_audit', $conditions) as $row) : ?>
                                        <option value="<?= $row->id ?>"><?= $row->subklausul_audit; ?></option>
                                    <?php endforeach; ?>
                                </select>
...
<script>
    $(document).ready(function() {
        ...
        $('.btn_save').click(function() {
            ...
            $.ajax({
                    url: BASE_URL + '/administrator/master_kriteria_audit/add_save',
                    type: 'POST',
                    dataType: 'json',
                    data: data_post,
                })
