...
<section class="content-header">
    <h1>
        Master Subklausul Audit <small><?= cclang('new', ['Master Subklausul Audit']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Master Subklausul Audit']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select-deselect" name="id_klausul" id="id_klausul" data-placeholder="Select Parent Klausul Audit">
                                    ...
                                    <?php foreach (db_get_all_data('master_klausul_audit', $conditions) as $row) : ?>
                                        <option value="<?= $row->id ?>"><?= $row->klausul_audit; ?></option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="form-group group-subklausul_audit ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="subklausul_audit" id="subklausul_audit" placeholder="Subklausul Audit" value="<?= set_value('subklausul_audit'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.btn_save').click(function() {
            ...
            $.ajax({
                    url: BASE_URL + '/administrator/master_subklausul_audit/add_save',
                    type: 'POST',
                    dataType: 'json',
                    data: data_post,
                })
