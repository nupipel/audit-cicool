...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="login-box-body">
      <img src="<?= BASE_URL . 'uploads/simak3/SIMAK3LOGO.png' ?>" alt="..." style="max-height: 100px">
      ...
      <div class="form-group has-feedback <?= form_error('username') ? 'has-error' : ''; ?>">
        <input type="text" class="form-control" placeholder="NIP / Username" name="username" value="">
