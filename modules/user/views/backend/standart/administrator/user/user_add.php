                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="form-group ">
                            <label for="username" class="col-sm-2 control-label">NIP / Username<i class="required">*</i></label>

                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="username" id="username" placeholder="NIP / Username" value="<?= set_value('username'); ?>">
                                <small class="info help-block">The username of user.</small>
                            </div>
                        </div>

                        <div class="form-group ">
                            <label for="full_name" class="col-sm-2 control-label"><?= cclang('nama') ?> <i class="required">*</i></label>
                        ...
                        <div class="form-group ">
                            <label for="jabatan" class="col-sm-2 control-label"><?= cclang('jabatan') ?> <i class="required">*</i></label>
                        ...
                        <div class="form-group ">
                            <label for="unit_kerja" class="col-sm-2 control-label"><?= cclang('unit_kerja') ?></label>
                        ...
                        <div class="form-group ">
                            <label for="lokasi_kerja" class="col-sm-2 control-label"><?= cclang('lokasi_kerja') ?> <i class="required">*</i></label>

                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="lokasi_kerja" id="lokasi_kerja" placeholder="lokasi_kerja" value="<?= set_value('lokasi_kerja'); ?>">
                                <small class="info help-block"></small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            <label for="user_avatar_galery" class="col-sm-2 control-label"><?= cclang('avatar') ?> </label>
