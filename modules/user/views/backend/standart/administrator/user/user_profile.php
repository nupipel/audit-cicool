            ...
            <div class="box box-widget widget-user-2">
              ...
              <div class="box-footer no-padding">
                <ul class="nav nav-stacked">
                  <li><a href="#"><i class='fa fa-user color-orange'></i> Nama <span class="pull-right "><?= _ent($user->full_name); ?></span></a></li>
                  <li><a href="#"><i class='fa fa-user-secret color-orange'></i> NIP / Username <span class="pull-right "><?= _ent($user->username); ?></span></a></li>
                  <li><a href="#"><i class='fa fa-calendar-check-o  color-orange'></i> Jabatan <span class="pull-right "><?= _ent($user->jabatan); ?></span></a></li>
                  <li><a href="#"><i class='fa fa-briefcase  color-orange'></i> Unit Kerja <span class="pull-right "><?= _ent($user->unit_kerja); ?></span></a></li>
                  <li><a href="#"><i class='fa fa-map-marker color-orange'></i> Lokasi Kerja <span class="pull-right "><?= _ent($user->lokasi_kerja); ?></span></a></li>
                </ul>
              </div>
            </div>
            <!-- /.widget-user -->
