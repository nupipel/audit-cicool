...
<section class="content-header">
    <h1>
        Kriteria Ketidaksesuaian        <small><?= cclang('new', ['Kriteria Ketidaksesuaian']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Kriteria Ketidaksesuaian']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        ?>
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="id_task" id="id_task" placeholder="Id Task" value="<?= set_value('id_task'); ?>">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="id_kriteria" id="id_kriteria" placeholder="Id Kriteria" value="<?= set_value('id_kriteria'); ?>">
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <textarea id="bukti_objektif" name="bukti_objektif" rows="5" cols="80"><?= set_value('Bukti Objektif'); ?></textarea>
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group date col-sm-8">
                                        <input type="text" class="form-control pull-right datepicker" name="target_waktu_selesai" placeholder="Target Waktu Selesai" id="target_waktu_selesai">
                                    </div>
                                    <small class="info help-block">
                                        </small>
                                </div>
                                ...
                                <div class="col-sm-8">
                                    <textarea id="penyebab" name="penyebab" rows="5" cols="80"><?= set_value('Penyebab'); ?></textarea>
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <textarea id="tindakan" name="tindakan" rows="5" cols="80"><?= set_value('Tindakan'); ?></textarea>
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="id_user" id="id_user" placeholder="Id User" value="<?= set_value('id_user'); ?>">
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
...
<script>
   ...
   var auditor = $('#auditor');
    ...
    $.ajax({
            url: BASE_URL + '/administrator/kriteria_ketidaksesuaian/add_save',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
